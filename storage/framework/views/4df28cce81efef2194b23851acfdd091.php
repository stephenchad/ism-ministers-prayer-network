            ...
            <div class="modern-card mx-auto" style="max-width: 700px;">
                <div class="video-player" style="position: relative;">
                    <video id="live-prayer-player" style="width: 100%; height: 400px; border-radius: 15px; background: #000;">
                        <?php if($stream->format === 'hls'): ?>
                            <source src="<?php echo e($stream->stream_url); ?>" type="application/x-mpegURL">
                        <?php else: ?>
                            <source src="<?php echo e($stream->stream_url); ?>" type="video/mp4">
                        <?php endif; ?>
                ...
                <div style="margin-top: 20px; text-align: center;">
                    <h3 id="live-prayer-title" style="color: #333; margin-bottom: 10px;">Now Playing: <?php echo e($stream->title); ?></h3>
                    <p id="live-prayer-description" style="color: #6c757d;"><?php echo e($stream->description ?? 'Join us in prayer.'); ?></p>
    ...
    <div class="modal-content" style="border-radius: 15px;">
      ...
      <form id="livePrayerForm">
          <div class="modal-body">
              <input type="hidden" name="stream_id" value="<?php echo e($stream->id ?? ''); ?>">
              <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (prayerForm) {
        prayerForm.addEventListener('submit', function(e) {
            ...
            fetch("<?php echo e(route('stream.participate')); ?>", {
                method: 'POST',
                headers: {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/front/partials/live_prayer_session.blade.php ENDPATH**/ ?>