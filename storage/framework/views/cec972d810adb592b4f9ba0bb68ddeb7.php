...
<div style="padding: 60px 0; background: #f8f9fa;">
    <div class="container">
        ...
        <?php if($radios->isNotEmpty()): ?>
        <!-- Radio Stations -->
        <div class="row mb-5">
            <?php $__currentLoopData = $radios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $radio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-6 mb-4">
                <div class="radio-player">
                    ...
                    <h3 style="color: #333; margin-bottom: 0.5rem;"><?php echo e($radio->name); ?></h3>
                    <p style="color: #6c757d; margin-bottom: 1rem;"><?php echo e($radio->description); ?></p>
                    <?php if($radio->genre): ?>
                    <span style="background: rgba(102, 126, 234, 0.1); color: #667eea; padding: 4px 12px; border-radius: 15px; font-size: 0.8rem; margin-bottom: 1rem; display: inline-block;"><?php echo e($radio->genre); ?></span>
                    <?php endif; ?>
                    
                    <button class="play-button" onclick="toggleRadio(<?php echo e($index); ?>, '<?php echo e($radio->stream_url); ?>')">
                        <i class="fas fa-play" id="playIcon<?php echo e($index); ?>"></i>
                        <i class="fas fa-pause" id="pauseIcon<?php echo e($index); ?>" style="display: none;"></i>
                    </button>
                    
                    <audio id="radioPlayer<?php echo e($index); ?>" preload="none" controls style="display: none;">
                        Your browser does not support the audio element.
                    </audio>
                    
                    <div class="volume-control">
                        <i class="fas fa-volume-down" style="color: #667eea;"></i>
                        <input type="range" class="volume-slider" min="0" max="100" value="50" onchange="setVolume(<?php echo e($index); ?>, this.value)">
                        <i class="fas fa-volume-up" style="color: #667eea;"></i>
                    </div>
                    
                    <!-- Schedule for this radio -->
                    <?php if($radio->schedules->isNotEmpty()): ?>
                    <div style="margin-top: 25px; text-align: left; background: rgba(255,255,255,0.9); border-radius: 15px; padding: 20px;">
                        ...
                        <div style="max-height: 250px; overflow-y: auto;">
                            <?php $__currentLoopData = $radio->schedules->sortBy('day_of_week'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <div>
                                        <div style="display: flex; align-items: center; margin-bottom: 5px;">
                                            <strong style="color: #333; font-size: 0.95rem;"><?php echo e(ucfirst($schedule->day_of_week)); ?></strong>
                                            <span style="background: #667eea; color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.75rem; margin-left: 10px;"><?php echo e(date('g:i A', strtotime($schedule->start_time))); ?> - <?php echo e(date('g:i A', strtotime($schedule->end_time))); ?></span>
                                        </div>
                                        <?php if($schedule->program_name): ?>
                                        <div style="color: #333; font-weight: 600; font-size: 0.9rem;"><?php echo e($schedule->program_name); ?></div>
                                        <?php endif; ?>
                                        <?php if($schedule->host_name): ?>
                                        <small style="color: #6c757d;"><i class="fas fa-microphone me-1"></i><?php echo e($schedule->host_name); ?></small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="modern-card text-center">
                    ...
                    <a href="<?php echo e(route('account.login')); ?>" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 30px; border-radius: 50px; text-decoration: none; font-weight: 600;">Login to Listen</a>
                </div>
            </div>
        </div>
        <?php endif; ?>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/front/radio.blade.php ENDPATH**/ ?>