<?php $__env->startSection('title', 'Add Page Content'); ?>
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Add New Page Content</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="<?php echo e(route('admin.page-content.index', ['page' => $page])); ?>" class="btn btn-secondary">
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="<?php echo e(route('admin.page-content.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" class="form-control content-editor"
                                              rows="8"
                                              placeholder="Main content in English (supports HTML)"><?php echo e(old('content')); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subtitle_es" class="form-control"
                                                   ...
                                                   value="<?php echo e(old('subtitle_es')); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea name="content_es" class="form-control content-editor"
                                              rows="8"
                                              placeholder="Contenido principal en español"><?php echo e(old('content_es')); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subtitle_fr" class="form-control"
                                                   ...
                                                   value="<?php echo e(old('subtitle_fr')); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea name="content_fr" class="form-control content-editor"
                                              rows="8"
                                              placeholder="Contenu principal en français"><?php echo e(old('content_fr')); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subtitle_pt" class="form-control"
                                                   ...
                                                   value="<?php echo e(old('subtitle_pt')); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea name="content_pt" class="form-control content-editor"
                                              rows="8"
                                              placeholder="Conteúdo principal em português"><?php echo e(old('content_pt')); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content_ar" class="form-control content-editor"
                                              ...
                                              dir="rtl"><?php echo e(old('content_ar')); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="image_mobile" class="form-control"
                                                   ...
                                                   value="<?php echo e(old('image_mobile')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="video_embed" class="form-control"
                                              rows="4"
                                              placeholder="<iframe>...</iframe> or <video>...</video>"><?php echo e(old('video_embed')); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="video_thumbnail" class="form-control"
                                           ...
                                           value="<?php echo e(old('video_thumbnail')); ?>">
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="link_text" class="form-control"
                                                   ...
                                                   value="<?php echo e(old('link_text')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="layout_style" class="form-select">
                                                <option value="default">Default (Content First)</option>
                                                <option value="image-left">Image Left, Content Right</option>
                                                <option value="image-right">Image Right, Content Left</option>
                                                <option value="image-top">Image Top, Content Bottom</option>
                                                <option value="image-bottom">Image Bottom, Content Top</option>
                                                ...
                                                <option value="card">Card/Box Style</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="column_count" class="form-select">
                                                ...
                                                <option value="2">2 Columns (Half/Half)</option>
                                                <option value="3">3 Columns (Thirds)</option>
                                                <option value="4">4 Columns (Quarter)</option>
                                            </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" id="bgColorOption" style="display: none;">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6" id="bgImageOption" style="display: none;">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="page" class="form-select" required>
                                                <option value="<?php echo e($page); ?>" selected>
                                                    <?php echo e(ucfirst(str_replace('-', ' ', $page))); ?>
                                                ...
                                                <?php $__currentLoopData = ['home', 'about', 'contact', 'prayer-room', 'stream', 'radio', 'testimonies', 'groups', 'news', 'events']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($pageName !== $page): ?>
                                                        <option value="<?php echo e($pageName); ?>"><?php echo e(ucfirst(str_replace('-', ' ', $pageName))); ?></option>
                                                    <?php endif; ?>
                                            ...
                                            <div class="section-selector">
                                                <select name="section_select" class="form-select" id="sectionSelect" onchange="handleSectionChange()">
                                                    ...
                                                    <?php $__currentLoopData = $commonSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($section); ?>"><?php echo e(ucfirst($section)); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="is_active" class="form-select">
                                                ...
                                                <option value="0" <?php echo e(old('is_active') === false ? 'selected' : ''); ?>>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/admin/page-content/create.blade.php ENDPATH**/ ?>