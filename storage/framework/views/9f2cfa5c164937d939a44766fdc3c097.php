            ...
            <div class="col-lg-8">
                ...
                <form id="groupForm" name="groupForm" method="POST" action="" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <a href="<?php echo e(route('account.myGroups')); ?>" class="btn btn-cancel">
...
<script>
    ...
    $("#groupForm").submit(function(e){
      ...
      $.ajax({
            url: '<?php echo e(route("account.saveGroup")); ?>',
            type: 'POST',
            ...
            success: function(response){
                if(response.status == false){
                    ...
                    window.location.href = "<?php echo e(route('account.myGroups')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/front/account/group/create.blade.php ENDPATH**/ ?>