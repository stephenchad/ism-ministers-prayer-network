...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('admin.radios')); ?>" class="btn btn-outline-secondary">
        ...
        <div class="col-lg-8">
            <div class="card" style="border: none; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                <div class="card-body" style="padding: 40px;">
                    <form action="<?php echo e(route('admin.radios.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" required style="border-radius: 8px; padding: 12px 15px;">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="genre" class="form-control <?php $__errorArgs = ['genre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('genre')); ?>" placeholder="e.g., Gospel, Worship, Teaching" style="border-radius: 8px; padding: 12px 15px;">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sort_order', 0)); ?>" style="border-radius: 8px; padding: 12px 15px;">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div id="schedule-container" data-old-schedules="<?php echo e(json_encode(old('schedules', []))); ?>">
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <a href="<?php echo e(route('admin.radios')); ?>" class="btn btn-outline-secondary flex-fill" style="padding: 12px 25px; border-radius: 8px; font-weight: 600;">
                                Cancel
                            </a>
                        </div>
                    </form>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/admin/radios/create.blade.php ENDPATH**/ ?>