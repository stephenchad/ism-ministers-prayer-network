    ...
    <div class="container">
        <div class="d-flex align-items-center justify-content-center mb-3">
            <div style="width: 80px; height: 80px; background: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 25px; overflow: hidden;">
                <?php if($group->image): ?>
                    <img src="<?php echo e(asset('storage/'.$group->image)); ?>" alt="<?php echo e($group->title); ?>" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                <?php else: ?>
                    <i class="fas fa-users" style="font-size: 2rem;"></i>
                <?php endif; ?>
            </div>
            <div>
                <h1 style="font-size: clamp(2rem, 5vw, 3.5rem); font-weight: 700; margin: 0;"><?php echo e($group->title); ?></h1>
                <p style="font-size: 1.2rem; opacity: 0.9; margin: 0;"><?php echo e(optional($group->category)->name); ?></p>
            </div>
        </div>
        <div style="background: rgba(255,255,255,0.1); padding: 15px 25px; border-radius: 20px; display: inline-block;">
            <div class="d-flex align-items-center gap-4">
                <span><i class="fas fa-users" style="margin-right: 8px;"></i><?php echo e($group->current_members); ?>/<?php echo e($group->max_members); ?> Members</span>
                <span><i class="fas fa-map-marker-alt" style="margin-right: 8px;"></i><?php echo e(optional($group->city)->name); ?>, <?php echo e(optional($group->country)->name); ?></span>
            ...
            <div class="container">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3 mb-4">
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(!$group->members->contains(Auth::user())): ?>
                            <?php if($group->current_members < $group->max_members): ?>
                                <form action="<?php echo e(route('account.joinGroup')); ?>" method="post" class="mt-4">
                                    <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                            ...
                            <form action="<?php echo e(route('account.leaveGroup')); ?>" method="post" class="d-flex align-items-center justify-content-center" style="min-width: 220px; height: 40px;">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="group_id" value="<?php echo e($group->id); ?>">
                    ...
                    <?php else: ?>
                        <div class="text-center">
                            ...
                            <form action="<?php echo e(route('login')); ?>" method="POST" class="d-inline-block text-start" style="max-width: 400px;">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                                ...
                                <p class="mt-3 mb-0">Do not have an account? <a href="<?php echo e(route('register')); ?>">Register here</a></p>
                            </form>
                        </div>
                    <?php endif; ?>

        <div class="mt-4 d-flex gap-2">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $group)): ?>
            <a href="<?php echo e(route('account.group.edit', $group->id)); ?>" class="btn btn-secondary"><i class="fas fa-edit me-2"></i>Edit Group Details</a>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manageMembers', $group)): ?>
            <a href="<?php echo e(route('account.group.manageMembers', $group->id)); ?>" class="btn btn-info"><i class="fas fa-users-cog me-2"></i>Manage Members</a>
            <?php endif; ?>
        </div>
            ...
            <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                <p style="color: #555; line-height: 1.8; font-size: 1.1rem; margin-bottom: 30px;">
                    <?php if(empty($group->description) || str_contains(strtolower($group->description), 'lorem ipsum')): ?>
                        Welcome to <?php echo e($group->title); ?>! This is a faith-based community where members come together for prayer, fellowship, and spiritual growth.
                    <?php else: ?>
                            ...
                            <div style="padding: 30px;">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $group->rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div style="background: #f8f9fa; padding: 15px 20px; border-radius: 15px; margin-bottom: 10px; border-left: 4px solid #667eea;">
                                        <p style="margin: 0; color: #555;"><?php echo e($rule->rule); ?></p>
                                    </div>
                            ...
                            <div style="padding: 30px;">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $group->events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div style="background: #f8f9fa; border-radius: 15px; padding: 25px; margin-bottom: 15px; border-left: 4px solid #667eea;">
                                        <h5 style="color: #333; font-weight: 700; margin-bottom: 10px;"><?php echo e($event->title); ?></h5>
                                        <p style="color: #555; margin-bottom: 15px;"><?php echo e($event->description); ?></p>
                                        <div style="display: flex; align-items: center; color: #6c757d;">
                                            <i class="fas fa-clock" style="margin-right: 8px;"></i>
                                            <span><?php echo e(\Carbon\Carbon::parse($event->event_date)->format('M d, Y, h:i A')); ?> - <?php echo e(\Carbon\Carbon::parse($event->start_time)->format('M d, Y, h:i A')); ?></span>
                        ...
                        <div class="modern-card" style="height: 100%;">
                            <div style="padding: 30px;">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $group->resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div style="background: #f8f9fa; padding: 15px 20px; border-radius: 15px; margin-bottom: 10px; border-left: 4px solid #667eea;">
                                        <a href="<?php echo e($resource->link); ?>" target="_blank" style="color: #667eea; text-decoration: none; font-weight: 600;">
                                            <i class="fas fa-external-link-alt" style="margin-right: 8px;"></i><?php echo e($resource->title); ?>
                ...
                <div class="modern-card" style="height: 100%;">
                    <div style="padding: 30px;">
                        <h4 style="color: #333; font-weight: 700; margin-bottom: 20px; display: flex; align-items: center;">
                            ...
                            Members (<?php echo e($group->members->count()); ?>)
                        </h4>

                        <?php $__empty_1 = true; $__currentLoopData = $sortedMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div style="width: 45px; height: 45px; background: linear-gradient(135deg, #ffc107 0%, #ff9800 100%); border-radius: 50%; display: flex; align-items-center; justify-content: center; color: white; font-weight: 700; font-size: 1rem;">
                                            <?php if($member->image): ?>
                                                <img src="<?php echo e(asset('storage/profile_pic/thumb/'.$member->image)); ?>" alt="<?php echo e($member->name); ?>" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                                            <?php else: ?>
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 style="margin: 0; color: #333; font-weight: 600; font-size: 0.9rem;"><?php echo e($member->name); ?></h6>
                ...
                <div class="modern-card" style="height: 100%;">
                    <div style="padding: 30px;">
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-3" id="photo-gallery">
                            <?php $__empty_1 = true; $__currentLoopData = $group->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="col position-relative">
                                    <a href="<?php echo e(asset('storage/'.$photo->path)); ?>" class="gallery-item" title="<?php echo e($photo->caption); ?>">
                                        <img src="<?php echo e(asset('storage/'.$photo->path)); ?>" class="img-fluid" alt="<?php echo e($photo->caption); ?>" style="border-radius: 10px; aspect-ratio: 1; object-fit: cover;">
                                    </a>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('managePhotos', $group)): ?>
                                        <form action="<?php echo e(route('group.photo.destroy', $photo->id)); ?>" method="POST" class="position-absolute top-0 end-0 p-2" style="z-index: 1;">
                                            <?php echo csrf_field(); ?>
            ...
            <div class="tab-pane fade" id="discussions" role="tabpanel" aria-labelledby="discussions-tab">
                ...
                <div class="discussion-list">
                    <?php $__empty_1 = true; $__currentLoopData = $group->discussions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discussion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="discussion-header d-flex align-items-center">
                                <div class="flex-shrink-0 me-3">
                                    <div style="width: 45px; height: 45px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700;">
                                        <?php if($discussion->user->image): ?>
                                            <img src="<?php echo e(asset('storage/profile_pic/thumb/'.$discussion->user->image)); ?>" alt="<?php echo e($discussion->user->name); ?>" class="rounded-circle" style="width: 100%; height: 100%; object-fit: cover;">
                                        <?php else: ?>
                                            <?php echo e(strtoupper(substr($discussion->user->name ?? 'A', 0, 1))); ?>

                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <h5 class="fw-bold mb-0"><?php echo e($discussion->title); ?></h5>
                                    <small class="text-muted">
                                        Posted by <strong><?php echo e($discussion->user->name ?? 'Anonymous'); ?></strong> &bull; <?php echo e($discussion->created_at->diffForHumans()); ?>

                                    </small>
                                </div>
                            </div>
                            <div class="discussion-body">
                                <p class="text-secondary mb-0" style="line-height: 1.7;"><?php echo e($discussion->content); ?></p>
                            </div>
                            <div class="discussion-footer">
                                <a class="btn btn-sm btn-outline-primary rounded-pill" data-bs-toggle="collapse" href="#replies-<?php echo e($discussion->id); ?>" role="button" aria-expanded="false" aria-controls="replies-<?php echo e($discussion->id); ?>">
                                    <i class="fas fa-reply me-1"></i> View Replies (<?php echo e($discussion->replies->count()); ?>)
                                </a>
                            </div>
                            <!-- Replies Section -->
                            <div class="collapse" id="replies-<?php echo e($discussion->id); ?>">
                                <div class="p-4">
                                    <?php $__empty_2 = true; $__currentLoopData = $discussion->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        <div class="reply-item">
                                            <img src="<?php echo e($reply->user->image ? asset('storage/profile_pic/thumb/'.$reply->user->image) : 'https://via.placeholder.com/35'); ?>" alt="<?php echo e($reply->user->name); ?>" class="reply-avatar">
                                            <div class="reply-content">
                                                <p class="mb-1 text-dark"><?php echo e($reply->content); ?></p>
                                                <small class="text-muted">
                                                    <strong><?php echo e($reply->user->name ?? 'Anonymous'); ?></strong> &bull; <?php echo e($reply->created_at->diffForHumans()); ?>
                                    ...
                                    <?php endif; ?>
                                    <!-- Reply Form -->
                                    <form action="<?php echo e(route('discussion.reply.store')); ?>" method="POST" class="mt-3 ms-5 reply-form">
                                        <?php echo csrf_field(); ?>
...
<div class="modal fade" id="newDiscussionModal" tabindex="-1" aria-labelledby="newDiscussionModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 20px;">
            ...
            <form id="newDiscussionForm" action="<?php echo e(route('discussion.store')); ?>" method="POST">
...
<?php if(Auth::check() && Auth::user()->id == $group->user_id): ?>
<div class="modal fade" id="transferOwnershipModal" tabindex="-1" aria-labelledby="transferOwnershipModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 20px;">
            ...
            <form action="<?php echo e(route('account.transferCoordinator')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="group_id" value="<?php echo e($group->id); ?>">
                <div class="modal-body">
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status) {
                    ...
                    var userAvatarHtml = '';
                    if (user.image) {
                        userAvatarHtml = `<img src="<?php echo e(asset('storage/profile_pic/thumb/')); ?>/${user.image}" alt="${user.name}" class="rounded-circle" style="width: 100%; height: 100%; object-fit: cover;">`;
                    } else {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/front/account/group/show.blade.php ENDPATH**/ ?>