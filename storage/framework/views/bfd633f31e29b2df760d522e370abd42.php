...
<head>
    ...
    <title>Create News/Event - ISM Prayer Network</title>
        ...
        <div class="col-lg-8">
            <div class="card shadow-lg border-0" style="border-radius: 20px; overflow: hidden;">
                <div class="card-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 25px 30px; border: none;">
                    <h4 class="mb-0" style="font-weight: 600;">Create News/Event</h4>
                </div>
                <div class="card-body" style="padding: 40px;">
                    <form action="<?php echo e(route('admin.news.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="excerpt" class="form-control" rows="3" style="border-radius: 15px; padding: 15px;" required></textarea>
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-bold">Content</label>
                            <textarea name="content" class="form-control" rows="8" style="border-radius: 15px; padding: 15px;" required></textarea>
                        </div>
                        ...
                        <div class="row event-fields" style="display: none;">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold">Event Date & Time</label>
                                    <input type="datetime-local" name="event_date" class="form-control" style="border-radius: 15px; padding: 15px;">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold">Event Location</label>
                                    <input type="text" name="event_location" class="form-control" style="border-radius: 15px; padding: 15px;">
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/admin/news/create.blade.php ENDPATH**/ ?>