    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.prayer-points.update', $prayerPoint->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="title" name="title" value="<?php echo e(old('title', $prayerPoint->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?> rich-text" id="content" name="content" rows="5" required><?php echo e(old('content', $prayerPoint->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="title_es" name="title_es" value="<?php echo e(old('title_es', $prayerPoint->title_es)); ?>">
...
unset($__errorArgs, $__bag); ?> rich-text" id="content_es" name="content_es" rows="5"><?php echo e(old('content_es', $prayerPoint->content_es)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="title_fr" name="title_fr" value="<?php echo e(old('title_fr', $prayerPoint->title_fr)); ?>">
...
unset($__errorArgs, $__bag); ?> rich-text" id="content_fr" name="content_fr" rows="5"><?php echo e(old('content_fr', $prayerPoint->content_fr)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="title_zh" name="title_zh" value="<?php echo e(old('title_zh', $prayerPoint->title_zh)); ?>">
...
unset($__errorArgs, $__bag); ?> rich-text" id="content_zh" name="content_zh" rows="5"><?php echo e(old('content_zh', $prayerPoint->content_zh)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="title_ar" name="title_ar" value="<?php echo e(old('title_ar', $prayerPoint->title_ar)); ?>">
...
unset($__errorArgs, $__bag); ?> rich-text" id="content_ar" name="content_ar" rows="5"><?php echo e(old('content_ar', $prayerPoint->content_ar)); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/admin/prayer-points/edit.blade.php ENDPATH**/ ?>