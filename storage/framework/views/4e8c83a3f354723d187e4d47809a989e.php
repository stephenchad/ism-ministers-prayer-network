...
?>
<html lang="<?php echo e(str_replace('_', '-', $locale)); ?>" <?php if($isRTL): ?> dir="rtl" <?php endif; ?> data-theme="<?php echo e($theme); ?>">
    ...
    <head>
        ...
        <title><?php echo $__env->yieldContent('title', 'Home'); ?> | ISM MINISTERS PRAYER NETWORK</title>
      
        
        <meta name="description" content="<?php echo $__env->yieldContent('description', 'Default description of the website.'); ?>">
        ...
        <!--================= Favicon =================-->
        <link rel="apple-touch-icon" href="<?php echo e(asset('assets/images/fav.png')); ?>">
        ...
        <?php endif; ?>
        <!--================= Menus css =================-->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/menus.css')); ?>">               
        <!--================= Animate css =================-->
        ...
        <!--================= Animations css =================-->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/animations.css')); ?>">  
        <!--================= Main stylesheet (must load before theme.css) =================-->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('style.css')); ?>">
        <!--================= Custom Spacing css =================-->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/custom-spacing.css')); ?>">
        <!--================= Responsive css =================-->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/responsive.css')); ?>">
        <!--================= Enhanced Responsive css =================-->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/enhanced-responsive.css')); ?>">
        <!--================= Custom css =================-->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/custom.css')); ?>">
        <!--================= Theme CSS =================-->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/theme.css')); ?>?v=<?php echo e(time()); ?>">
    ...
    <body data-user-authenticated="<?php echo e(Auth::check() ? 'true' : 'false'); ?>">
        <!--================= Preloader Section Start Here =================-->        
        <div id="react__preloader">
            <div id="react__circle_loader"></div>
            <div class="react__loader_logo"><img src="<?php echo e(asset('assets/images/preload.png')); ?>" alt="Preload"></div>
        </div>        
                    ...
                    <div class="react-main-menu">
                        <nav>
                            ...
                            <div class="menu-toggle" style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
                                <div class="logo"><a href="<?php echo e(route('home')); ?>" class="logo-text"> <img src="<?php echo e(asset('assets/images/ism-logo-light.png')); ?>" alt="ISM Ministers Prayer Network Logo" style="max-height: 50px;"> </a></div>
                            ...
                            <div class="react-inner-menus" style="justify-content: space-between;">
                                <div style="display: flex; align-items: center;">
                                    <div class="logo" style="margin-inline-end: 30px;"><a href="<?php echo e(route('home')); ?>" class="logo-text"> <img src="<?php echo e(asset('assets/images/ism-logo-light.png')); ?>" alt="logo" style="max-height: 50px;"> </a></div>
                                    ...
                                    <li> <a href="<?php echo e(route('prayers')); ?>">Prayers</a>
                                        <ul>
                                            <li><a href="<?php echo e(route('prayers')); ?>">Prayers</a></li>
                                            <li><a href="<?php echo e(route('prayer-points.index')); ?>">Prayer Points</a></li>
                                            <li><a href="<?php echo e(route('prayer-room')); ?>">Prayer Room</a></li>
                                        </ul>
                                    </li>
                                    <li> <a href="<?php echo e(route('groups.index')); ?>">Groups</a></li>
                                    <li> <a href="<?php echo e(route('testimonies')); ?>">Testimonies</a></li>
                                    <?php if(auth()->guard()->check()): ?>
                                    <li> <a href="<?php echo e(route('stream')); ?>">Stream</a></li>
                                    <li> <a href="<?php echo e(route('radio')); ?>">Radio</a></li>
                                    <?php endif; ?>
                                ...
                                <div class="searchbar-part">
                                    <form class="search-form" method="GET" action="<?php echo e(route('search')); ?>">
                                        <div style="position: relative; display: flex; align-items: center; background: var(--bg-secondary); border-radius: 25px; padding: 8px 15px; backdrop-filter: blur(10px); border: 1px solid var(--border-color);">
                                            <input type="text" name="q" id="keyword" placeholder="Search..." value="<?php echo e(is_string(request('q')) ? request('q') : ''); ?>" style="background: transparent; border: none; outline: none; color: var(--text-primary); padding: 5px 10px; width: 200px; font-size: 14px;" required aria-label="Search site">
                                    ...
                                    <div id="theme-switcher-container">
                                        <div class="theme-switcher">
                                            ...
                                            <div class="theme-dropdown">
                                                ...
                                                <button class="theme-option <?php echo e($theme === 'light' ? 'active' : ''); ?>" data-theme="light" type="button">
                                                    <span class="theme-option-icon theme-icon sun">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
                                                    </span>
                                                    <span class="theme-option-text">Light</span>
                                                </button>
                                                <button class="theme-option <?php echo e($theme === 'dark' ? 'active' : ''); ?>" data-theme="dark" type="button">
                                                ...
                                                <button class="theme-option <?php echo e($theme === 'system' ? 'active' : ''); ?>" data-theme="system" type="button">
                                    ...
                                    <noscript>
                                        ...
                                        <div style="display: flex; gap: 10px; margin-inline-start: 10px;">
                                            <a href="?theme=light" style="padding: 5px 10px; border: 1px solid var(--border-color); border-radius: 5px; <?php echo e($theme === 'light' ? 'background: var(--primary-color); color: white;' : ''); ?>">Light</a>
                                            <a href="?theme=dark" style="padding: 5px 10px; border: 1px solid var(--border-color); border-radius: 5px; <?php echo e($theme === 'dark' ? 'background: var(--primary-color); color: white;' : ''); ?>">Dark</a>
                                            <a href="?theme=system" style="padding: 5px 10px; border: 1px solid var(--border-color); border-radius: 5px; <?php echo e($theme === 'system' ? 'background: var(--primary-color); color: white;' : ''); ?>">System</a>
                                        </div>
                                    </noscript>
                                    ...
                                    <div class="react-login" style="white-space: nowrap;">
                                        <?php if(!Auth::check()): ?>
                                            <a href="<?php echo e(route('account.login')); ?>" aria-label="Log in to your account">
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e(route('account.logout')); ?>" aria-label="Log out of your account">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="footer-card">
                            <img src="<?php echo e(asset('assets/images/ism-logo-light.png')); ?>" alt="ISM Prayer Network" style="max-width: 200px; margin-bottom: 20px;">
                    ...
                    <div class="col-lg-2">
                        <div class="footer-card">
                            ...
                            <a href="<?php echo e(route('prayer-points.index')); ?>" class="footer-link">Prayer Points</a>
                            <a href="<?php echo e(route('testimonies')); ?>" class="footer-link">Testimonies</a>
                    ...
                    <div class="col-lg-2">
                        <div class="footer-card">
                            ...
                            <a href="<?php echo e(route('groups.index')); ?>" class="footer-link">Groups</a>
                            <a href="<?php echo e(route('prayer.resources')); ?>" class="footer-link">Prayer Resources</a>
                            <a href="<?php echo e(route('programs.index')); ?>" class="footer-link">Programs</a>
                            <a href="<?php echo e(route('news.index')); ?>" class="footer-link">News</a>
                            <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('stream')); ?>" class="footer-link">Stream</a>
                            <a href="<?php echo e(route('radio')); ?>" class="footer-link">Radio</a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="col-lg-4">
        ...
        <!--================= menus js =================-->
        <script src="<?php echo e(asset('assets/js/menus.js')); ?>"></script>
        <!--================= Plugins js =================-->
        <script src="<?php echo e(asset('assets/js/plugins.js')); ?>"></script>       
        <!--================= Main js =================-->
        <script src="<?php echo e(asset('assets/js/main.js')); ?>"></script>
        <!--================= Loading States js =================-->
        <script src="<?php echo e(asset('assets/js/loading-states.js')); ?>"></script>
        <!--================= Theme Switcher js =================-->
        ...
        <script>
            ...
            $('#newsletter-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("newsletter.subscribe")); ?>',
                    method: 'POST',
                    data: { email: email },
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/front/layouts/app.blade.php ENDPATH**/ ?>