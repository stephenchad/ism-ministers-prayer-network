        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div style="position: relative;">
                    <img src="<?php echo e(asset('assets/images/about/ab.png')); ?>" alt="About" style="width: 100%; border-radius: 20px; box-shadow: 0 20px 40px rgba(0,0,0,0.1);">
...
<div class="stats-section">
    <div class="container">
        ...
        <div class="row">
            <?php if(isset($aboutStats) && $aboutStats->isNotEmpty()): ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="<?php echo e(route('coordinators')); ?>" style="text-decoration: none; color: inherit;">
                    <div class="team-card" style="cursor: pointer;">
                        ...
                        <div class="team-info">
                            ...
                            <p style="color: #667eea; font-weight: 600; margin-bottom: 1rem;"><?php echo e($coordinator->title); ?></p>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/front/about.blade.php ENDPATH**/ ?>