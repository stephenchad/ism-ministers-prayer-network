...
<div style="padding: 80px 0; background: #f8f9fa;">
    <div class="container">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select name="prayer_type" class="form-control" id="prayerType" required>
                                            ...
                                            <?php $__currentLoopData = $prayerTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($type->slug); ?>"><?php echo e($type->icon); ?> <?php echo e($type->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $prayerRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="prayer-wall-item">
                        <h5>
                            ...
                            ?>
                            <?php echo e($type->icon ?? '💝'); ?> <?php echo e($type->name ?? ucfirst($request->prayer_type)); ?> Prayer
                        </h5>
                        <p><?php echo e(Str::limit($request->prayer_request, 150)); ?></p>
                        <small class="text-muted">
                            <?php echo e($request->created_at ? $request->created_at->diffForHumans() : 'Recently'); ?>

                            <?php if($request->name): ?> • by <?php echo e($request->name); ?> <?php endif; ?>
                        </small>
                    </div>
        ...
        <div id="resources" class="tab-content" style="display: none;">
            <div class="row">
                <div class="col-md-4">
                    <a href="<?php echo e(route('prayer.resources')); ?>" style="text-decoration: none; color: inherit;">
                ...
                <div class="col-md-4">
                    <a href="<?php echo e(route('worship.music')); ?>" style="text-decoration: none; color: inherit;">
                        <div class="modern-card text-center" style="cursor: pointer;">
                            <div style="font-size: 3rem; margin-bottom: 20px;">🎵</div>
                            <h4>Worship Music</h4>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/front/prayers.blade.php ENDPATH**/ ?>