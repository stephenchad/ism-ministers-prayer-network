<div class="profile-sidebar card shadow-sm border-0 rounded-3 p-4 mb-4">
    <div class="text-center mb-4 position-relative">
        ...
        <?php if(Auth::user()->image != ''): ?>
            <img id="profile-image" src="<?php echo e(asset('profile_pic/thumb/'.Auth::user()->image)); ?>" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;" alt="avatar">
        <?php else: ?>
            <img id="profile-image" src="<?php echo e(asset('assets/images/profile/1.jpg')); ?>" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;" alt="avatar">
        <?php endif; ?>
    ...
    <h5 class="text-center mb-3"><?php echo e(Auth::user()->name); ?></h5>
    <p class="text-muted text-center mb-4"><?php echo e(Auth::user()->designation ?? 'No designation specified'); ?></p>
                ...
                <form id="profilePicForm" name="profilePicForm" action="" method="post">
                    ...
                    <div class="text-center mb-4">
                        <div class="image-preview-container mb-3">
                            <img id="image-preview" src="<?php echo e(asset('assets/images/profile/1.jpg')); ?>" 
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/front/account/sidebar.blade.php ENDPATH**/ ?>