        ...
        <div class="col-lg-8">
            <div class="card" style="border: none; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                <div class="card-body" style="padding: 40px;">
                    <form action="<?php echo e(route('admin.coordinators.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" rows="4" required style="border-radius: 8px; padding: 12px 15px;"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('phone')); ?>" required style="border-radius: 8px; padding: 12px 15px;">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" required style="border-radius: 8px; padding: 12px 15px;">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('availability')); ?>" placeholder="e.g., Mon-Fri: 9AM-6PM EST" required style="border-radius: 8px; padding: 12px 15px;">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/admin/coordinators/create.blade.php ENDPATH**/ ?>