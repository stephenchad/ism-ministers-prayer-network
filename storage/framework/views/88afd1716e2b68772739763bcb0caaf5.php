...
<div class="modern-hero">
    <div class="container">
        ...
        <p style="font-size: 1.2rem; opacity: 0.9;"><?php echo e($prayerPoint->title); ?></p>
    </div>
</div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="modern-card">
                    <h2 style="color: #667eea; margin-bottom: 20px;"><?php echo e($prayerPoint->title ?: ($prayerPoint->title_es ?: ($prayerPoint->title_fr ?: ($prayerPoint->title_zh ?: $prayerPoint->title_ar)))); ?></h2>
                    <?php
                    ...
                    <?php if($hasMultiple): ?>
                        <ul class="nav nav-tabs" id="languageTabs" role="tablist">
                            <?php if($prayerPoint->title || $prayerPoint->content): ?>
                            ...
                            <?php endif; ?>
                            <?php if($prayerPoint->title_es || $prayerPoint->content_es): ?>
                                <li class="nav-item" role="presentation">
                            ...
                            <?php endif; ?>
                            <?php if($prayerPoint->title_fr || $prayerPoint->content_fr): ?>
                                <li class="nav-item" role="presentation">
                            ...
                            <?php endif; ?>
                            <?php if($prayerPoint->title_zh || $prayerPoint->content_zh): ?>
                                <li class="nav-item" role="presentation">
                            ...
                            <?php endif; ?>
                            <?php if($prayerPoint->title_ar || $prayerPoint->content_ar): ?>
                                <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="languageTabsContent">
                            <?php if($prayerPoint->title || $prayerPoint->content): ?>
                                <div class="tab-pane fade show active" id="en" role="tabpanel" aria-labelledby="en-tab">
                                    <div class="prayer-content">
                                        <?php echo nl2br(e($prayerPoint->content)); ?>
                            ...
                            <?php if($prayerPoint->title_es || $prayerPoint->content_es): ?>
                                <div class="tab-pane fade" id="es" role="tabpanel" aria-labelledby="es-tab">
                                    <div class="prayer-content">
                                        <?php echo nl2br(e($prayerPoint->content_es)); ?>
                            ...
                            <?php if($prayerPoint->title_fr || $prayerPoint->content_fr): ?>
                                <div class="tab-pane fade" id="fr" role="tabpanel" aria-labelledby="fr-tab">
                                    <div class="prayer-content">
                                        <?php echo nl2br(e($prayerPoint->content_fr)); ?>
                            ...
                            <?php if($prayerPoint->title_zh || $prayerPoint->content_zh): ?>
                                <div class="tab-pane fade" id="zh" role="tabpanel" aria-labelledby="zh-tab">
                                    <div class="prayer-content">
                                        <?php echo nl2br(e($prayerPoint->content_zh)); ?>
                            ...
                            <?php if($prayerPoint->title_ar || $prayerPoint->content_ar): ?>
                                <div class="tab-pane fade" id="ar" role="tabpanel" aria-labelledby="ar-tab">
                                    <div class="prayer-content">
                                        <?php echo nl2br(e($prayerPoint->content_ar)); ?>
                    ...
                    <?php else: ?>
                        <div class="prayer-content">
                            <?php echo nl2br(e($prayerPoint->content ?: ($prayerPoint->content_es ?: ($prayerPoint->content_fr ?: ($prayerPoint->content_zh ?: $prayerPoint->content_ar))))); ?>

                        </div>
                    <?php endif; ?>
                    <p style="color: #6c757d; font-size: 0.9rem;">Shared on <?php echo e($prayerPoint->created_at->format('F j, Y')); ?></p>
                    <a href="<?php echo e(route('prayer-points.index')); ?>" class="back-link">← Back to Prayer Points</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/front/prayer-points/show.blade.php ENDPATH**/ ?>