...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a class="nav-link active" href="<?php echo e(route('admin.users')); ?>">
            ...
            <div class="topbar-content">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <a href="<?php echo e(route('admin.users')); ?>" class="btn btn-light btn-sm">
            ...
            <form id="userForm" name="userForm" method="POST" action="">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" id="name" value="<?php echo e($user->name); ?>" class="form-control" placeholder="Enter full name">
                        <p class="text-danger mt-1"></p>
                    </div>
                    <div class="col-md-6">
                        <label for="email" class="form-label fw-bold">Email</label>
                        <input type="email" name="email" id="email" value="<?php echo e($user->email); ?>" class="form-control" placeholder="Enter email address">
                        <p class="text-danger mt-1"></p>
                    </div>
                    <div class="col-md-6">
                        <label for="designation" class="form-label fw-bold">Designation</label>
                        <input type="text" name="designation" id="designation" value="<?php echo e($user->designation); ?>" class="form-control" placeholder="Enter designation">
                        <p class="text-danger mt-1"></p>
                    </div>
                    <div class="col-md-6">
                        <label for="mobile" class="form-label fw-bold">Mobile</label>
                        <input type="tel" name="mobile" id="mobile" value="<?php echo e($user->mobile); ?>" class="form-control" placeholder="Enter phone number">
                        <p class="text-danger mt-1"></p>
                    </div>
                    <div class="col-md-6">
    ...
    <script>
        $("#userForm").submit(function(e){
            ...
            $.ajax({
                url: '<?php echo e(route("admin.users.update", $user->id)); ?>',
                type: 'PUT',
                dataType: 'json',
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>