...
<?php $__env->startSection('title', 'Prayer Room | ISM Ministers Prayer Network'); ?>

<?php $__env->startSection('description', 'Enter the sacred space where heaven meets earth. Join our virtual prayer room for guided prayer, scripture meditation, and community intercession.'); ?>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div style="position: relative;">
                    <img src="<?php echo e(asset('assets/images/hero/hero1.jpg')); ?>" alt="Prayer Room" style="width: 100%; border-radius: 20px; box-shadow: 0 20px 40px rgba(0,0,0,0.1);" onerror="this.src='<?php echo e(asset('assets/images/preload.png')); ?>'">
            ...
            <div class="col-lg-6">
                <div style="padding-left: 40px;">
                    ...
                    <div style="display: flex; gap: 20px; margin-top: 30px;">
                        ...
                        <a href="<?php echo e(route('prayers')); ?>" style="border: 2px solid #667eea; color: #667eea; padding: 15px 30px; border-radius: 50px; text-decoration: none; font-weight: 600; transition: all 0.3s ease;" onmouseover="this.style.backgroundColor='#667eea'; this.style.color='white';" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#667eea';">Submit Request</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="featured-resources-section">
    <div class="container">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="resource-card p-4 text-center">
                    <div class="resource-icon">
                        <?php if($item->resource_type == 'file'): ?>
                            <i class="fas fa-file-pdf"></i>
                        <?php elseif($item->resource_type == 'video'): ?>
                            <i class="fas fa-play"></i>
                        <?php else: ?>
                            <i class="fas fa-book"></i>
                        <?php endif; ?>
                    </div>
                    <h6 class="fw-bold mb-2"><?php echo e(Str::limit($item->title, 40)); ?></h6>
                    <p class="text-muted small mb-3"><?php echo e(Str::limit($item->description, 80)); ?></p>
                    <?php if($item->resource_type == 'file'): ?>
                        <a href="<?php echo e(route('prayer.download', $item->id)); ?>" class="btn btn-primary btn-sm">
                            <i class="fas fa-download me-1"></i>Download
                        </a>
                    <?php elseif($item->resource_type == 'video'): ?>
                        <?php if($item->video_url): ?>
                            <a href="<?php echo e($item->video_url); ?>" target="_blank" class="btn btn-primary btn-sm">
                                <i class="fas fa-play me-1"></i>Watch
                            </a>
                        <?php else: ?>
                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#videoModal<?php echo e($item->id); ?>">
                                <i class="fas fa-play me-1"></i>Watch
                            </button>
                        <?php endif; ?>
                    <?php else: ?>
                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#guideModal<?php echo e($item->id); ?>">
        ...
        <div class="text-center mt-4">
            <a href="<?php echo e(route('prayer.resources')); ?>" class="btn btn-outline-primary">
...
<?php if(in_array($guide->id, $featured->pluck('id')->toArray())): ?>
...
<?php if($video->video_file && in_array($video->id, $featured->pluck('id')->toArray())): ?>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/front/prayer-room.blade.php ENDPATH**/ ?>