...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a class="nav-link" href="<?php echo e(route('admin.referrals')); ?>">
                <i class="fas fa-share-alt me-2"></i> Referrals
            </a>
            <a class="nav-link active" href="<?php echo e(route('admin.bulk-messages.index')); ?>">
    ...
    <div class="main-content">
        ...
        <div class="content-card p-4">
            <div class="mb-4">
                ...
                <span class="detail-value"><?php echo e($bulkMessage->id); ?></span>
            </div>
            <div class="mb-4">
                <span class="detail-label">Type:</span>
                <span class="detail-value">
                    <span class="badge bg-<?php echo e($bulkMessage->type === 'email' ? 'primary' : 'success'); ?>">
                        <?php echo e(ucfirst($bulkMessage->type)); ?>
            ...
            <div class="mb-4">
                ...
                <span class="detail-value"><?php echo e($bulkMessage->subject ?? 'N/A'); ?></span>
            </div>
            <div class="mb-4">
                <span class="detail-label">Message:</span>
                <p class="detail-value"><?php echo e($bulkMessage->message); ?></p>
            </div>
            <div class="mb-4">
                <span class="detail-label">Total Recipients:</span>
                <span class="detail-value"><?php echo e($bulkMessage->total_recipients); ?></span>
            </div>
            <div class="mb-4">
                <span class="detail-label">Sent Count:</span>
                <span class="detail-value"><?php echo e($bulkMessage->sent_count); ?></span>
            </div>
            <div class="mb-4">
                <span class="detail-label">Failed Count:</span>
                <span class="detail-value"><?php echo e($bulkMessage->failed_count); ?></span>
            </div>
            <div class="mb-4">
                <span class="detail-label">Sent At:</span>
                <span class="detail-value"><?php echo e($bulkMessage->sent_at ? $bulkMessage->sent_at->format('M d, Y H:i') : 'Pending'); ?></span>
            </div>
            <div class="mb-4">
                <span class="detail-label">Sender:</span>
                <span class="detail-value"><?php echo e($bulkMessage->sender->name ?? 'Unknown'); ?></span>
            </div>

            <?php if($bulkMessage->failed_count > 0 && !empty($bulkMessage->failed_recipients)): ?>
                <div class="mb-4">
                    <span class="detail-label">Failed Recipients:</span>
                    <?php $__currentLoopData = $bulkMessage->failed_recipients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $failed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="failed-recipient">
                            <strong>User ID:</strong> <?php echo e($failed['user_id'] ?? 'N/A'); ?><br>
                            <strong>Email:</strong> <?php echo e($failed['email'] ?? 'N/A'); ?><br>
                            <strong>Mobile:</strong> <?php echo e($failed['mobile'] ?? 'N/A'); ?><br>
                            <strong>Error:</strong> <?php echo e($failed['error'] ?? 'N/A'); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ism_ministers_prayer_network/resources/views/admin/bulk-messages/show.blade.php ENDPATH**/ ?>