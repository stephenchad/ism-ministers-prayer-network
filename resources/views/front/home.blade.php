    ...
    <div class="react-wrapper-inner">
        ...
        <div class="react-slider-part">
            <div class="home-sliders home2 owl-carousel">
                ...
                <div class="single-slide">
                    <div class="slider-img">
                        @if($slider->desktop_image)
                            <img class="desktop" src="{{ asset($slider->desktop_image) }}" alt="{{ $slider->title }}">
                        @else
                            <img class="desktop" src="{{ asset('assets/images/slider/30-DAYS-PRAYER-FEST-WEBSITE-BANNER.jpeg') }}" alt="{{ $slider->title }}">
                        @endif
                        @if($slider->mobile_image)
                            <img class="mobile" src="{{ asset($slider->mobile_image) }}" alt="{{ $slider->title }}">
                        @else
                            <img class="mobile" src="{{ asset('assets/images/slider/11.jpg') }}" alt="{{ $slider->title }}">
                        @endif
                    </div>
                    <div class="container">
                        <div class="slider-content">
                            <div class="content-part">
                                ...
                                <div class="slider-btn">
                                    <a href="{{ $slider->button_url }}" class="react-btn-border">{{ $slider->button_text }}</a>
                                </div>
                                @endif
                            </div>
                        </div>
                ...
                <div class="single-slide">
                    <div class="slider-img">
                        <img class="desktop" src="{{ asset('assets/images/slider/30-DAYS-PRAYER-FEST-WEBSITE-BANNER.jpeg') }}" alt="30 Days Prayer Festival">
                        <img class="mobile" src="{{ asset('assets/images/slider/11.jpg') }}" alt="30 Days Prayer Festival Mobile">
                    </div>
                    <div class="container">
                        <div class="slider-content">
                            <div class="content-part">
                                ...
                                <div class="slider-btn">
                                    <a href="{{ route('account.registration') }}" class="react-btn-border">Join Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        @include('front.partials.live_prayer_session')
        <!--================= Live Prayer Sessions Section End Here =================-->

        <!--================= Prayer Services Section Start Here =================-->
        @if($howWeServeSection && $howWeServeSection->meta_data)
        <div style="padding: 100px 0; background: #f8f9fa;">
            <div class="container">
                <div class="text-center mb-5">
                    <h2 style="font-size: 2.5rem; font-weight: 700; color: #333; margin-bottom: 1rem;">{{ $howWeServeSection->title }}</h2>
                    <p style="color: #6c757d; font-size: 1.1rem;">{{ $howWeServeSection->subtitle }}</p>
                </div>
                <div class="row">
                    @foreach(is_string($howWeServeSection->meta_data) ? json_decode($howWeServeSection->meta_data, true) ?? [] : ($howWeServeSection->meta_data ?? []) as $item)
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div style="background: white; border-radius: 15px; padding: 40px 30px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.1); transition: transform 0.3s ease; height: 100%;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                            <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 25px;">
                                <i class="fas {{ $item['icon'] ?? 'fa-praying-hands' }}" style="font-size: 2rem; color: white;"></i>
                            </div>
                            <h4 style="color: #333; margin-bottom: 15px; font-weight: 600;">{{ $item['title'] }}</h4>
                            <p style="color: #6c757d; margin-bottom: 20px; line-height: 1.6;">{{ $item['description'] }}</p>
                            <a href="{{ $item['url'] }}" style="color: #667eea; font-weight: 600; text-decoration: none;">{{ $item['button_text'] ?? 'Learn More →' }}</a>
                        </div>
                    </div>
                    @endforeach
                </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div style="background: white; border-radius: 15px; padding: 40px 30px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.1); transition: transform 0.3s ease; height: 100%;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                            ...
                            <a href="{{ route('prayers') }}" style="color: #667eea; font-weight: 600; text-decoration: none;">Submit a Request →</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div style="background: white; border-radius: 15px; padding: 40px 30px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.1); transition: transform 0.3s ease; height: 100%;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                            ...
                            <a href="{{ route('groups.index') }}" style="color: #667eea; font-weight: 600; text-decoration: none;">Join Groups →</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div style="background: white; border-radius: 15px; padding: 40px 30px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.1); transition: transform 0.3s ease; height: 100%;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                            ...
                            <a href="{{ route('testimonies') }}" style="color: #667eea; font-weight: 600; text-decoration: none;">Read Stories →</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div style="background: white; border-radius: 15px; padding: 40px 30px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.1); transition: transform 0.3s ease; height: 100%;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                            ...
                            <a href="{{ route('prayer-points.index') }}" style="color: #667eea; font-weight: 600; text-decoration: none;">Read Points →</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div style="background: white; border-radius: 20px; padding: 40px 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.1); height: 100%; text-align: center; cursor: pointer;" onclick="window.location.href='{{ route('prayer-points.show', $point->id) }}'">
                            ...
                            <h5 style="color: #333; margin-bottom: 15px; font-weight: 600;">{{ $point->title }}</h5>
                            <p style="color: #6c757d; margin-bottom: 20px; line-height: 1.6; font-style: italic;">"{{ Str::limit($point->content, 120) }}"</p>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <div style="position: relative;">
                            <img src="{{ asset('assets/images/about/about2.png') }}" alt="Prayer Community" style="width: 100%; border-radius: 20px; box-shadow: 0 20px 40px rgba(0,0,0,0.1);" onerror="this.onerror=null;this.src='{{ asset('assets/images/about/about22.png') }}'">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div style="text-align: center; padding: 30px; background: rgba(255,255,255,0.1); border-radius: 15px; backdrop-filter: blur(10px);">
                            <h3 style="font-size: 3rem; font-weight: 700; margin-bottom: 10px;">{{ $stat->value }}</h3>
                            <h5 style="margin-bottom: 10px; font-weight: 600;">{{ $stat->label }}</h5>
                            <p style="opacity: 0.8; margin: 0;">{{ $stat->description }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
                ...
                <div class="row">
                    @foreach($programs as $program)
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card border-0 shadow-lg" style="border-radius: 20px; overflow: hidden; cursor: pointer; transition: transform 0.3s ease; height: 100%;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'" onclick="window.location.href='{{ route('programs.show', $program->slug) }}'">
                                @if($program->image)
                                    <img src="{{ asset('storage/' . $program->image) }}" class="card-img-top" style="height: 200px; object-fit: cover;" alt="{{ $program->title }}">
                                @else
                                    <div style="height: 200px; background: {{ $program->color }}; display: flex; align-items: center; justify-content: center;">
                                        <i class="{{ $program->icon }}" style="font-size: 4rem; color: white;"></i>
                                    </div>
                                @endif
                                <div class="card-body" style="background: {{ $program->color }}; color: white; text-align: center; padding: 30px; display: flex; flex-direction: column; justify-content: space-between; flex: 1;">
                                    <div>
                                        <h4 style="margin-bottom: 20px; font-weight: 600;">{{ $program->title }}</h4>
                                        <p style="opacity: 0.9; line-height: 1.6; margin-bottom: 25px;">{{ $program->description }}</p>
                                    </div>
                    ...
                    @foreach($news as $article)
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card border-0 shadow-lg" style="border-radius: 20px; overflow: hidden; cursor: pointer; transition: transform 0.3s ease; height: 100%;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'" onclick="window.location.href='{{ route('news.show', $article->slug) }}'">
                                @if($article->image)
                                    <img src="{{ asset('storage/' . $article->image) }}" class="card-img-top" style="height: 200px; object-fit: cover;" alt="{{ $article->title }}">
                                @else
                                    <div style="height: 200px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center;">
                                        <i class="fas {{ $article->type == 'event' ? 'fa-calendar-alt' : 'fa-newspaper' }}" style="font-size: 4rem; color: white;"></i>
                                    </div>
                                @endif
                                <div class="card-body" style="padding: 30px;">
                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                                        <span style="background: {{ $article->type == 'event' ? '#28a745' : '#667eea' }}; color: white; padding: 5px 15px; border-radius: 20px; font-size: 0.8rem; font-weight: 600; text-transform: uppercase;">{{ $article->type }}</span>
                                        <small style="color: #6c757d;">{{ $article->created_at->format('M d, Y') }}</small>
                                    </div>
                                    <h5 style="color: #333; margin-bottom: 15px; font-weight: 600; line-height: 1.4;">{{ $article->title }}</h5>
                                    <p style="color: #6c757d; margin-bottom: 20px; line-height: 1.6;">{{ Str::limit($article->excerpt, 100) }}</p>
        ...
        <div style="padding: 100px 0; background: white;">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div style="background: white; border-radius: 20px; padding: 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.1); height: 100%; cursor: pointer; transition: transform 0.3s ease;" onclick="window.location.href='{{ route('books.view', $book['id']) }}'" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                            @if(isset($book['cover_image']))
                                <img src="{{ $book['cover_image'] }}" alt="{{ $book['title'] }}" style="width: 100%; height: 250px; object-fit: cover; border-radius: 10px; margin-bottom: 20px;">
                            @else
                            ...
                            @endif
                            <h5 style="color: #333; margin-bottom: 10px; font-weight: 600;">{{ $book['title'] }}</h5>
                            @if(isset($book['author']))
                                <p style="color: #6c757d; margin-bottom: 10px; font-size: 0.9rem;">by {{ $book['author'] }}</p>
                            @endif
                            <p style="color: #6c757d; margin-bottom: 15px; line-height: 1.6;">{{ Str::limit($book['description'] ?? '', 80) }}</p>
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <span style="color: #667eea; font-weight: 700; font-size: 1.2rem;">${{ number_format($book['price'] ?? 0, 2) }}</span>
                ...
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('books.browse') }}" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; border-radius: 50px; text-decoration: none; font-weight: 600; display: inline-block;">Browse Books →</a>
                </div>
                @endif
                @if(!empty($books) && count($books) > 0)
                <div class="text-center mt-4">
        ...
        <div style="padding: 100px 0; background: #f8f9fa;">
            <div class="container">
                ...
                <div class="row">
                    @foreach($testimonies->take(3) as $testimony)
                    <div class="col-lg-4 mb-4">
                        <div style="background: white; border-radius: 20px; padding: 40px 30px; box-shadow: 0 15px 35px rgba(0,0,0,0.1); height: 100%; text-align: center;">
                            ...
                            <h5 style="color: #333; margin-bottom: 15px; font-weight: 600;">{{ $testimony->title }}</h5>
                            <p style="color: #6c757d; margin-bottom: 20px; line-height: 1.6; font-style: italic;">"{{ Str::limit($testimony->testimony, 120) }}"</p>
                            <p style="color: #667eea; font-weight: 600; margin: 0;">- {{ $testimony->name }}@if($testimony->location), {{ $testimony->location }}@endif</p>
                            @if($testimony->category)
                            <span style="background: rgba(102, 126, 234, 0.1); color: #667eea; padding: 4px 12px; border-radius: 15px; font-size: 0.8rem; margin-top: 10px; display: inline-block;">{{ ucfirst($testimony->category) }}</span>
                            @endif
                        </div>
                    </div>
                    @endforeach
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('testimonies') }}" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 35px; border-radius: 50px; text-decoration: none; font-weight: 600; display: inline-block; transition: transform 0.3s ease;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='translateY(0)'">
                        Read more →
                    </a>
                </div>
            </div>
