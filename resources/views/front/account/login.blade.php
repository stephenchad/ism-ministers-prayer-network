            ...
            <div class="col-lg-5 col-md-7">
                <div class="login-card">
                    ...
                    <div class="login-header">
                        ...
                        <h2>Welcome back</h2>
                        <p>Don’t have an account? <a href="{{ route('account.registration') }}">Create one</a></p>
                    </div>
                    ...
                    <div class="social-login">
                        ...
                        <div class="social-buttons">
                            ...
                            <!-- <a href="{{ route('social.login', 'tiktok') }}" class="btn-social btn-tiktok">
                                <i class="fab fa-tiktok"></i>
                                Continue with TikTok
                            </a>
                            <a href="{{ route('social.login', 'twitter') }}" class="btn-social btn-twitter">
                                <i class="fab fa-twitter"></i>
                                Continue with Twitter
                            </a>
                            <a href="{{ route('social.login', 'linkedin') }}" class="btn-social btn-linkedin">
                                <i class="fab fa-linkedin-in"></i>
                                Continue with LinkedIn
                            </a>
                            <!-- KingsChat login button removed due to unsupported driver -->
                            <!-- <a href="{{ route('social.login', 'kingschat') }}" class="btn-social btn-kingschat">
