...
<div class="modern-hero">
    <div class="container">
        <div class="d-flex align-items-center justify-content-center mb-3">
            ...
            <div>
                <h1 style="font-size: 3rem; font-weight: 700; margin: 0;">{{ $group->title }}</h1>
                <p style="font-size: 1.1rem; opacity: 0.9; margin: 0;">Prayer Group Chat</p>
            </div>
        </div>
        <div class="group-info">
            <div class="d-flex align-items-center justify-content-center gap-4">
                <span><i class="fas fa-users" style="margin-right: 8px;"></i>{{ $group->current_members }} Members</span>
                @if($group->category)
                <span><i class="fas fa-tag" style="margin-right: 8px;"></i>{{ $group->category->name }}</span>
                @endif
            ...
            <div class="col-lg-10">
                <div class="chat-container">
                    <div class="chat-header">
                        ...
                        <a href="{{ route('account.group.show', $group->id) }}" class="btn" style="background: rgba(255,255,255,0.2); color: white; border: none; border-radius: 15px; padding: 8px 15px;">
        ...
        if (message.trim() !== '') {
            ...
            messageElement.innerHTML = `
                <div class="message-user">
                    ...
                    <div>
                        <strong style="color: #333; font-size: 0.9rem;">{{ auth()->user()->name ?? 'You' }}</strong>
