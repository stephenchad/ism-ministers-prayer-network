                ...
                <div class="modern-card">
                    ...
                    <div style="margin-top: 20px;">
                        <h3 id="current-title" style="color: #333; margin-bottom: 10px;">
                            @if($streams->isNotEmpty())
                                Now Playing: {{ $streams->first()->title }}
                            @else
                        ...
                        <p id="current-description" style="color: #6c757d;">
                            @if($streams->isNotEmpty())
                                {{ $streams->first()->description ?? 'Default Description' }}
                            @else
                                Default Description
                            @endif
                        </p>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="channel-card {{ $stream->type }}" onclick="switchChannel('{{ $stream->id }}', '{{ $stream->stream_url }}', '{{ $stream->format }}')">
                    ...
                    <p style="color: #6c757d; margin-bottom: 10px;">{{ $stream->description ?? 'No description available' }}</p>
