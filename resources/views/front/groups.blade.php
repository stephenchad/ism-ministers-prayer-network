...
<div style="padding: 80px 0; background: #f8f9fa;">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            ...
            <a href="{{ route('account.createGroup') }}" class="btn-modern">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="group-card">
                        <div class="group-image">
                            @if($group->image)
                                <img src="{{ asset('storage/'.$group->image) }}" alt="{{ $group->title }}" style="width: 100%; height: 100%; object-fit: cover;">
                            @else
                                {{ strtoupper(substr($group->title, 0, 2)) }}
                            @endif
                        </div>
                        <div style="padding: 25px;">
                            <h4 style="color: #333; margin-bottom: 15px; font-weight: 700;">{{ Str::limit($group->title, 30) }}</h4>
                            <p style="color: #6c757d; margin-bottom: 20px; line-height: 1.6;">{{ Str::limit($group->description ?? 'Join this prayer group to connect with fellow believers.', 80) }}</p>
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                <a href="{{ route('account.group.show', $group->id) }}" class="btn btn-outline-modern btn-sm">
                                    <i class="fas fa-eye" style="margin-right: 5px;"></i>View
                                </a>
                                <a href="{{ route('account.group.chat', $group->id) }}" class="btn btn-outline-modern btn-sm">
                                ...
                                <button class="btn btn-outline-modern btn-sm" data-bs-toggle="modal" data-bs-target="#meetingModal" 
                                        ...
                                        data-stream-type="{{ $group->stream_type ?? 'hls' }}">
