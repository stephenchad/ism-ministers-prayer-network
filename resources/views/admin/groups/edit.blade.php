...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a class="nav-link active" href="{{ route('admin.groups') }}">
            ...
            <div class="topbar-content">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <a href="{{ route('admin.groups') }}" class="btn btn-light btn-sm">
            ...
            <form id="editGroupForm" name="editGroupForm" method="POST" action="">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="title" id="title" value="{{ $group->title }}" class="form-control" placeholder="Enter group name">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="address" id="address" value="{{ $group->address }}" class="form-control" placeholder="Enter address">
                        <p class="text-danger mt-1"></p>
                    </div>
                    <div class="col-md-12">
                        <label for="description" class="form-label fw-bold">Description</label>
                        <textarea name="description" id="description" class="form-control" rows="3" placeholder="Enter description">{{ $group->description }}</textarea>
                        <p class="text-danger mt-1"></p>
                    </div>
                    <div class="col-md-6">
                        <label for="category_name" class="form-label fw-bold">Category</label>
                        <input type="text" name="category_name" id="category_name" value="{{ $group->category->name ?? '' }}" class="form-control" placeholder="Enter category">
                        <p class="text-danger mt-1"></p>
                    </div>
                    <div class="col-md-6">
                        <label for="group_type_name" class="form-label fw-bold">Group Type</label>
                        <input type="text" name="group_type_name" id="group_type_name" value="{{ $group->group_type->name ?? '' }}" class="form-control" placeholder="Enter group type">
                        <p class="text-danger mt-1"></p>
                    </div>
                    <div class="col-12">
    ...
    <script>
        ...
        $('#country_id').on('change', function() {
            ...
            $.ajax({
                url: '{{ route("admin.groups.getCities") }}',
                type: 'GET',
