                ...
                <div class="card-body" style="padding: 40px;">
                    <form action="{{ route('admin.programs.update', $program->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" value="{{ $program->title }}" class="form-control" style="border-radius: 15px; padding: 15px;" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-bold">Description</label>
                            <textarea name="description" class="form-control" rows="3" style="border-radius: 15px; padding: 15px;" required>{{ $program->description }}</textarea>
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-bold">Details</label>
                            <textarea name="details" class="form-control" rows="5" style="border-radius: 15px; padding: 15px;" required>{{ $program->details }}</textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="schedule" value="{{ $program->schedule }}" class="form-control" style="border-radius: 15px; padding: 15px;" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold">Location</label>
                                    <input type="text" name="location" value="{{ $program->location }}" class="form-control" style="border-radius: 15px; padding: 15px;" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="icon" value="{{ $program->icon }}" class="form-control" style="border-radius: 15px; padding: 15px;" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold">Color</label>
                                    <input type="color" name="color" value="{{ $program->color }}" class="form-control" style="border-radius: 15px; padding: 15px;" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @if($program->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $program->image) }}" alt="Current Image" style="max-width: 200px; border-radius: 10px;">
                                </div>
                            @endif
                        ...
                        <div class="mb-4">
                            <div class="form-check">
                                <input type="checkbox" name="status" value="1" {{ $program->status ? 'checked' : '' }} class="form-check-input">
