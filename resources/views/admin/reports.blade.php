        ...
        <div class="page-actions">
            <div class="export-buttons">
                ...
                <div class="export-links" id="exportLinks" style="display: none;">
                    <a class="export-link" href="{{ route('admin.reports.export', ['type' => 'all', 'format' => 'csv']) }}">
                        <i class="fas fa-file-csv me-1"></i> All Data (CSV)
                    </a>
                    <a class="export-link" href="{{ route('admin.reports.export', ['type' => 'users', 'format' => 'csv']) }}">
                        <i class="fas fa-users me-1"></i> Users (CSV)
                    </a>
                    <a class="export-link" href="{{ route('admin.reports.export', ['type' => 'groups', 'format' => 'csv']) }}">
                        <i class="fas fa-users-cog me-1"></i> Groups (CSV)
                    </a>
                    <a class="export-link" href="{{ route('admin.reports.export', ['type' => 'prayers', 'format' => 'csv']) }}">
                        <i class="fas fa-praying-hands me-1"></i> Prayers (CSV)
                    </a>
                    <a class="export-link" href="{{ route('admin.reports.export', ['type' => 'testimonies', 'format' => 'csv']) }}">
                        <i class="fas fa-heart me-1"></i> Testimonies (CSV)
                    </a>
                    <a class="export-link" href="{{ route('admin.reports.export', ['type' => 'all', 'format' => 'json']) }}">
    ...
    <div class="stats-grid fade-in">
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <div class="stat-trend up">
                    ...
                    <span>+{{ $stats['userGrowth'] ?? 12 }}% this month</span>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <div class="stat-trend up">
                    <i class="fas fa-arrow-up"></i>
                    <span>+{{ $stats['groupGrowth'] ?? 8 }}% this month</span>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <div class="stat-trend up">
                    <i class="fas fa-arrow-up"></i>
                    <span>+{{ $stats['prayerGrowth'] ?? 15 }}% this month</span>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <div class="stat-trend up">
                    <i class="fas fa-arrow-up"></i>
                    <span>+{{ $stats['testimonyGrowth'] ?? 5 }}% this month</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function initUserGrowthChart() {
            ...
            userGrowthChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'New Users',
                        data: {!! json_encode($userGrowthData ?? [10, 25, 32, 45, 67, 89]) !!},
                        ...
                        label: 'Active Users',
                        data: {!! json_encode($activeUserData ?? [8, 20, 28, 40, 58, 78]) !!},
        ...
        function initUserRoleChart() {
            ...
            userRoleChart = new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: {!! json_encode($userRoleLabels ?? ['Members', 'Leaders', 'Coordinators', 'Admins']) !!},
                    datasets: [{
                        data: {!! json_encode($userRoleData ?? [65, 25, 8, 2]) !!},
        ...
        function initPrayerChart() {
            ...
            prayerChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: {!! json_encode($prayerLabels ?? ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun']) !!},
                    datasets: [{
                        label: 'Prayer Requests',
                        data: {!! json_encode($prayerData ?? [12, 19, 15, 25, 22, 8, 5]) !!},
                        backgroundColor: colors.primary,
                        borderRadius: 8
                    }, {
                        label: 'Prayers Answered',
                        data: {!! json_encode($prayerAnsweredData ?? [8, 12, 10, 18, 15, 4, 3]) !!},
        ...
        function initGroupsChart() {
            ...
            groupsChart = new Chart(ctx, {
                type: 'pie',
                data: {
                    labels: {!! json_encode($groupCategoryLabels ?? ['Prayer', 'Worship', 'Study', 'Fellowship', 'Outreach']) !!},
                    datasets: [{
                        data: {!! json_encode($groupCategoryData ?? [35, 25, 20, 12, 8]) !!},
                        backgroundColor: chartColors,
                        borderWidth: 0
                    }]
                },
            ...
            activityHeatmap = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: {!! json_encode($weeklyActivityData ?? [85, 92, 78, 95, 88, 45, 52]) !!},
                        borderColor: colors.primary,
