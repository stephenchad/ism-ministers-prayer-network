                ...
                <div class="card-body" style="padding: 40px;">
                    <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" value="{{ $news->title }}" class="form-control" style="border-radius: 15px; padding: 15px;" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="excerpt" class="form-control" rows="3" style="border-radius: 15px; padding: 15px;" required>{{ $news->excerpt }}</textarea>
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-bold">Content</label>
                            <textarea name="content" class="form-control" rows="8" style="border-radius: 15px; padding: 15px;" required>{{ $news->content }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @if($news->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $news->image) }}" alt="Current Image" style="max-width: 200px; border-radius: 10px;">
                                </div>
                            @endif
                            <input type="file" name="image" class="form-control" style="border-radius: 15px; padding: 15px;" accept="image/*">
                        </div>

                        <div class="row event-fields" style="{{ $news->type == 'event' ? '' : 'display: none;' }}">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold">Event Date & Time</label>
                                    <input type="datetime-local" name="event_date" value="{{ $news->event_date ? $news->event_date->format('Y-m-d\TH:i') : '' }}" class="form-control" style="border-radius: 15px; padding: 15px;">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-bold">Event Location</label>
                                    <input type="text" name="event_location" value="{{ $news->event_location }}" class="form-control" style="border-radius: 15px; padding: 15px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-check">
                                        <input type="checkbox" name="is_featured" value="1" {{ $news->is_featured ? 'checked' : '' }} class="form-check-input">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <div class="form-check">
                                        <input type="checkbox" name="status" value="1" {{ $news->status ? 'checked' : '' }} class="form-check-input">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.news.index') }}" class="btn btn-secondary" style="border-radius: 25px; padding: 12px 30px;">Cancel</a>
