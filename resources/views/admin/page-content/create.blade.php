        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('admin.page-content.index', ['page' => $page]) }}" class="btn btn-secondary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" class="form-control content-editor"
                                              rows="8"
                                              placeholder="Main content in English (supports HTML)">{{ old('content') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content_es" class="form-control content-editor"
                                              rows="8"
                                              placeholder="Contenido principal en español">{{ old('content_es') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content_fr" class="form-control content-editor"
                                              rows="8"
                                              placeholder="Contenu principal en français">{{ old('content_fr') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content_pt" class="form-control content-editor"
                                              rows="8"
                                              placeholder="Conteúdo principal em português">{{ old('content_pt') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="video_embed" class="form-control"
                                              rows="4"
                                              placeholder="<iframe>...</iframe> or <video>...</video>">{{ old('video_embed') }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="page" class="form-select" required>
                                                ...
                                                @foreach(['home', 'about', 'contact', 'prayer-room', 'stream', 'radio', 'testimonies', 'groups', 'news', 'events'] as $pageName)
                                                    @if($pageName !== $page)
                                                        <option value="{{ $pageName }}">{{ ucfirst(str_replace('-', ' ', $pageName)) }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        </div>
